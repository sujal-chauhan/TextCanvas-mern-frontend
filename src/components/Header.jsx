...
const Header = () => {
  ...
  return (
    ...
    >
      ...
      >
        <p>Bring your ideas to life with beautiful visuals</p>
      ...
      >
        Create <span className="text-violet-900">images</span> from <span className="text-violet-900">text</span> in an instant
      </motion.h1>
      ...
      >
        Let AI shape wonders—type your vision and watch it transform into stunning art within moments
      </motion.p>
      ...
      className="flex flex-wrap justify-center mt-16 gap-3">
        ...
        className='mt-2 text-neutral-600' >Visual creations crafted with TextCanvas</motion.p>
